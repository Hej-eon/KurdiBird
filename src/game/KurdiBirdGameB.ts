...
export class KurdiBirdScene extends Phaser.Scene {
  ...
  private createBird(): void {
    ...
    this.birdBody = this.add.ellipse(BIRD_X, HEIGHT * 0.48, BIRD_RADIUS * 2, BIRD_RADIUS * 2, 0xffffff, 0)
      .setDepth(4);
  ...
  private spawnPipePair(): void {
    ...
    const bottom = this.add.rectangle(x, bottomY + bottomHeight / 2, PIPE_WIDTH, Math.max(40, bottomHeight), 0xb73b47)
      .setStrokeStyle(3, 0x7a2230).setDepth(1);
